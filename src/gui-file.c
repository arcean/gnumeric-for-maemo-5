...
#ifdef GNM_USE_HILDON
		hildon_banner_show_information (GTK_WIDGET (wbcg_toplevel (wbcg)), NULL, _("File opened"));
...
#ifdef GNM_USE_HILDON
		hildon_banner_show_information (GTK_WIDGET (wbcg_toplevel (new_wbcg)), NULL, _("File opened"));
		gtk_widget_hide(new_wbcg->mainWindow);
		gtk_widget_unrealize(new_wbcg->mainWindow);
		gtk_widget_show(wbcg_toplevel (new_wbcg));
#endif
	}
...
#ifdef GNM_USE_HILDON
	if(success)
		hildon_banner_show_information (GTK_WIDGET (wbcg), NULL, _("File saved"));
#endif
