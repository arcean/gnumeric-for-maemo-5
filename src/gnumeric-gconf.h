...
GOConfNode *gnm_conf_get_core_gui_editing_hotkey_node (void);
gboolean gnm_conf_get_core_gui_editing_hotkey (void);
void gnm_conf_set_core_gui_editing_hotkey (gboolean);

#ifdef GNM_USE_HILDON
GOConfNode *gnm_conf_get_core_gui_editing_showcursor_node (void);
gboolean gnm_conf_get_core_gui_editing_showcursor (void);
void gnm_conf_set_core_gui_editing_showcursor (gboolean);

GOConfNode *gnm_conf_get_core_gui_editing_portraitmode_node (void);
gboolean gnm_conf_get_core_gui_editing_portraitmode (void);
void gnm_conf_set_core_gui_editing_portraitmode (gboolean);

GOConfNode *gnm_conf_get_core_gui_editing_launchpage_node (void);
gboolean gnm_conf_get_core_gui_editing_launchpage (void);
void gnm_conf_set_core_gui_editing_launchpage (gboolean);

GOConfNode *gnm_conf_get_core_gui_editing_standard_tb_node (void);
gboolean gnm_conf_get_core_gui_editing_standard_tb (void);
void gnm_conf_set_core_gui_editing_standard_tb (gboolean);

GOConfNode *gnm_conf_get_core_gui_editing_format_tb_node (void);
gboolean gnm_conf_get_core_gui_editing_format_tb (void);
void gnm_conf_set_core_gui_editing_format_tb (gboolean);

GOConfNode *gnm_conf_get_core_gui_editing_object_tb_node (void);
gboolean gnm_conf_get_core_gui_editing_object_tb (void);
void gnm_conf_set_core_gui_editing_object_tb (gboolean);
#endif
