		  ...
		  gboolean is_col, gboolean is_row)
{
	...
	static GnumericPopupMenuElement popup_elements[] = { 
		...
		{ N_("Cu_t"),           "HILDON_CUT",
		    CONTEXT_DISPLAY_FOR_CELLS, 0, CONTEXT_CUT },
		{ N_("_Copy"),          "HILDON_COPY",
		    CONTEXT_DISPLAY_FOR_CELLS, 0, CONTEXT_COPY },
		{ N_("_Paste"),         "HILDON_PASTE",
		    CONTEXT_DISPLAY_FOR_CELLS, 0, CONTEXT_PASTE },
		...
		{ N_("F_ull Screen"), GTK_STOCK_ZOOM_FIT,
		    CONTEXT_DISPLAY_FOR_CELLS, 0, CONTEXT_FULL_SCREEN },
